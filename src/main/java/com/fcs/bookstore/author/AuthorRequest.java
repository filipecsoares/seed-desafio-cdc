...
public record AuthorRequest(
        ...
        @NotBlank(message = "email is required") @Email(message = "email must be a well-formed email address") @Size(max = 200, message = "email must be at most 200 characters") @UniqueEmail String email,
